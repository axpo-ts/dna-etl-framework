...
write_table_name = f"{catalog_name}.{schema_name}.usage_dbu"
...
create_ddl = f"""CREATE TABLE IF NOT EXISTS {write_table_name} (
  ...
  updated_by STRING,
  CONSTRAINT `pk_usage_dbu` PRIMARY KEY (`timestamp`, `workspace_id`))
USING delta;"""

spark.sql(create_ddl)

read_tables = {
    "usage_dbu_1week_fcty": "4071172135320476",
    "usage_dbu_1week_prod": "2433690965938898",
    "usage_dbu_1week_snbx": "3549828462202385",
}
