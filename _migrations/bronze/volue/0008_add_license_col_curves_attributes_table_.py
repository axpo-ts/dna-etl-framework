...
target_schema_name = "volue"

columns_to_add = "license"
column_values = "WATTSIGH_INFSERVICE_WATTSIGH"
tables = [
    "curves_attributes",
]
...
# Process each table
for table in tables:
    full_table_name = f"{catalog_prefix}{target_catalog_name}.{schema_prefix}{target_schema_name}.{table}"
