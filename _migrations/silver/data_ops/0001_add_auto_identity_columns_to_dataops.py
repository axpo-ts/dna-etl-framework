...
#     df = spark.sql(
#         f"select column_name from `system`.information_schema.constraint_column_usage "
...
# table_id_prefix_clause = "table_id BIGINT not null GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1)," # noqa: E501
