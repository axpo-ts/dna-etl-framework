...
CreateTable(context=context, table_model=dayahead_volume_flexpool_table).execute()
...
CreateTable(context=context, table_model=intraday_price_volume_flexpool_table).execute()
