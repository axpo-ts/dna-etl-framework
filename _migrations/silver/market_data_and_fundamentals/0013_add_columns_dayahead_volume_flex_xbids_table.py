...
table_name_target = f"{catalog_prefix}silver.{schema_prefix}market_data_and_fundamentals.dayahead_volume_flex_xbids"
table_name_source = f"{catalog_prefix}bronze.{schema_prefix}advanced_analytics_shared.fact_france_timeseries"
primary_keys = "delivery_start,value_column".split(",")
columns_to_add = "run_time_id,project_name_fr_actual_too,year_month_day".split(",")
filter = "timeseries_id__ch__actual____too LIKE '%settled%' AND timeseries_id__ch__actual____too LIKE '%da%'"
