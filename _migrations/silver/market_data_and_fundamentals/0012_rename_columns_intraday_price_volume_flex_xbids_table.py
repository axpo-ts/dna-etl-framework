...
table_name = f"{catalog_prefix}silver.{schema_prefix}market_data_and_fundamentals.intraday_price_volume_flex_xbids"
    ...
    if "timestamp_utc_von" in df.columns:
        (
            ...
            SELECT
                ...
                time_file_creation_utc_von AS time_file_creation,
