...
meteomatics_precipitation_forecast_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="precipitation_forecast"),
    schema=StructType(
        [
    ...
    comment="The forecasted amount of precipitation that has fallen during the indicated interval. Here, precipitation is the sum of liquid (rain, freezing rain), mix (sleet), and solid (hail, graupel, snow) precipitation. The total amount of precipitation is the sum of convective and large-scale precipitation.",
    sources=[
