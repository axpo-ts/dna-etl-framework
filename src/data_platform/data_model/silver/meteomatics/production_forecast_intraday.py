...
meteomatics_production_forecast_intraday_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="production_forecast_intraday"),
    schema=StructType(
        [
