...
meteomatics_wind_speed_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="wind_speed"),
    schema=StructType(
        [
    ...
    comment="The instantaneous wind speed at the indicated level above ground or pressure level.",
    sources=[
