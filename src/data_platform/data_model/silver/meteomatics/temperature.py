...
meteomatics_temperature_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="temperature"),
    schema=StructType(
        [
    ...
    comment="The instantaneous temperature at the indicated level above ground or pressure level in the corresponding unit.",
    sources=[
