...
meteomatics_wind_speed_forecast_intraday_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="wind_speed_forecast_intraday"),
    schema=StructType(
        [
    ...
    comment="The forecasted wind speed at the indicated level above ground or pressure level.",
    sources=[
