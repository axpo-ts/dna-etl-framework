...
meteomatics_cloud_cover_forecast_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="cloud_cover_forecast"),
    schema=StructType(
        [
    ...
    comment="The forecasted amount of cloud cover in percent or octas.",
    sources=[
