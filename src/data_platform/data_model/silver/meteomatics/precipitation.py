...
meteomatics_precipitation_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="precipitation"),
    schema=StructType(
        [
    ...
    comment="The actual amount of precipitation that has fallen during the indicated interval. Here, precipitation is the sum of liquid (rain, freezing rain), mix (sleet), and solid (hail, graupel, snow) precipitation. The total amount of precipitation is the sum of convective and large-scale precipitation.",
    sources=[
