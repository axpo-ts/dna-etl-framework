...
meteomatics_temperature_forecast_intraday_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="temperature_forecast_intraday"),
    schema=StructType(
        [
    ...
    comment="The forecasted temperature at the indicated level above ground or pressure level in the corresponding unit.",
    sources=[
