...
meteomatics_wind_direction_forecast_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="wind_direction_forecast"),
    schema=StructType(
        [
    ...
    comment="The forecasted wind direction at the indicated level above ground or pressure level, in degrees from North.",
    sources=[
