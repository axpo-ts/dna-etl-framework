...
meteomatics_pressure_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="pressure"),
    schema=StructType(
        [
    ...
    comment="The actual pressure adjusted to sea level. To adjust the pressure to the mean sea level atmospheric conditions such as temperature are taken into account.",
    sources=[
