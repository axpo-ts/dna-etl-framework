...
from data_platform.data_model.silver.meteomatics.meteomatics_common import METEOMATICS_COMMON_TAGS, meteomatics_standard_columns

meteomatics_solar_radiation_forecast_intraday_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="solar_radiation_forecast_intraday"),
    schema=StructType(
        [
            ...
            meteomatics_standard_columns.LatestModelLoadColumn.to_struct_field(),
        ]
    ),
    comment="The forecasted instantaneous flux of radiation (diffuse + direct radiation) for the specified delivery period in Watts per square meter.",
    sources=[
        TableIdentifier(catalog="bronze", schema="meteomatics", name="intraday"),
    ],
    tags={
