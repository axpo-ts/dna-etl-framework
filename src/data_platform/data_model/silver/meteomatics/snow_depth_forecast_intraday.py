...
meteomatics_snow_depth_forecast_intraday_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="snow_depth_forecast_intraday"),
    schema=StructType(
        [
    ...
    comment="The forecasted snow depth.",
    sources=[
