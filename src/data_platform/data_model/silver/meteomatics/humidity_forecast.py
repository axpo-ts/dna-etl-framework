...
meteomatics_humidity_forecast_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteomatics", name="humidity_forecast"),
    schema=StructType(
        [
    ...
    comment="The forecasted value of the relative humidity in percent at the indicated level above ground or pressure level.",
    sources=[
