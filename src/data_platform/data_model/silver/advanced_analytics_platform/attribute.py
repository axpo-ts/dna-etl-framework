...
attribute_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver", schema="advanced_analytics_platform", name="attribute"
    ),
    schema=StructType([
    ...
    comment="Attributes (e.g.,license, unit, etc.) that are associated with various entities within Advanced Analytics Platform.",
    sources=[
        TableIdentifier(catalog="bronze", schema="advanced_analytics_shared", name="attribute")
    ],
    tags={
