...
invoicing_price_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue_ems",
        name="invoicing_price"
    ),
    schema=StructType([
        ...
        volue_ems_standard_columns.InvoicingComponentColumn.to_struct_field(
            comment="Type of fee included in the invoice"
        ),
        standard_columns.UnitColumn.to_struct_field(comment="Fee unit"),
        volue_ems_standard_columns.TimeLevelColumn.to_struct_field(),
        StructField("timestamp", TimestampType(), False, {"comment": "Timestamp"}),
        StructField("value", DoubleType(), False, {"comment": "Fee at timestamp"}),
        standard_columns.LicenseColumn.to_struct_field(),
    ]),
    comment="Invoicing fees from CIS_PRI data group",
    sources=[
