...
commercial_exchange_scheduled_forecast_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="commercial_exchange_scheduled_forecast"
    ),
    comment=(
        "Day-ahead commercial flow forecast from Volue between various market areas. An instance is identified with an issue date, "
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The day-ahead commercial flow forecast in the specified unit"}),
