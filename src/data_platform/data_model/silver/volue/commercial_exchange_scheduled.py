...
commercial_exchange_scheduled_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="commercial_exchange_scheduled"
    ),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The day-ahead commercial flow in the specified unit"}),
    ...
    comment=(
        "Day-ahead commercial flow from Volue between various market areas. Each curve maps directly to a single time series instance."
    ),
    sources=[
       TableIdentifier(catalog="bronze",schema="volue",name="time_series_a")
    ],
