...
temperature_consumption_forecast_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="temperature_consumption_forecast"
    ),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The consumption temperature forecast value in the specified unit"}),
    ...
    comment=(
        "Consumption temperature forecast from Volue. Instance curves and tagged curves store multiple time series. "
