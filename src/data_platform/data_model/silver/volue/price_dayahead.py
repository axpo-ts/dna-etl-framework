...
price_dayahead_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="volue", name="price_dayahead"),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The actual day-ahead power price, in the specified unit"}),
    ...
    comment="The actual day-ahead power prices. Each curve maps directly to a single time series instance.",
    ...
    partition_cols=[volue_standard_columns.CurveNameColumn.name],
