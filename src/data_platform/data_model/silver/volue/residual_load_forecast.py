...
residual_load_forecast_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="residual_load_forecast"
    ),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The forecasted value of residual power consumption, in the specified unit"}),
    ...
    comment=(
        "Forecasts of residual power consumption. Instance curves and tagged curves store multiple time series. "
