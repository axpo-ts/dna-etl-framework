...
from .volue_common import VOLUE_COMMON_TAGS, VOLUE_LICENSE, volue_standard_columns, VOLUE_TIMESERIES_TAGGED_PRIMARY_KEYS

price_intraday_auction_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="volue", name="price_intraday_auction"),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The intraday power auction price in the specified unit"}),
    ...
    comment="The intraday power auction prices in various delivery areas from EPEX. Each curve maps directly to a single time series instance.",
    sources=[TableIdentifier(catalog="bronze", schema="volue", name="tagged_a")],
    ...
    primary_keys=VOLUE_TIMESERIES_TAGGED_PRIMARY_KEYS,
)
