...
production_table = StaticTableModel(
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The actual power production value in the specified unit"}),
    ...
    comment=(
        "The actual power production values from Volue. Each curve maps directly to a single time series instance."
    ),
    sources=[
