...
consumption_forecast_table = StaticTableModel(
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "Consumption forecast value in the specified unit"}),
    ...
    comment=(
        "Consumption forecast from Volue for different areas. Instance curves and tagged curves store multiple time series. "
