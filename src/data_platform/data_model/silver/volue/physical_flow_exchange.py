...
physical_flow_exchange_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="volue", name="physical_flow_exchange"),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The actual volume of the physical flow exchange in the specified unit"}),
    ...
    comment="The sum of physical net imports. Each curve maps directly to a single time series instance.",
