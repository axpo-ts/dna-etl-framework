...
residual_load_table = StaticTableModel(
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The value of residual power consumption, in the specified unit"}),
    ...
    comment=(
        "The values of residual power consumption. Instance curves and tagged curves store multiple time series. "
