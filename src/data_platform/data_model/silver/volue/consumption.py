...
consumption_table = StaticTableModel(
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "Consumption value in the specified unit"}),
    ...
    comment=(
        "Consumption from Volue for the the different areas. Each curve maps directly to a single time series instance."
    ),
    sources=[
