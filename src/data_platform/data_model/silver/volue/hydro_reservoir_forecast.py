...
hydro_reservoir_forecast_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="hydro_reservoir_forecast"
    ),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The forecasted measurement of hydro reservoir level, in the specified unit"}),
    ...
    comment=(
        "The forecasted measurements of hydro reservoir levels. Instance curves and tagged curves store multiple time series. "
