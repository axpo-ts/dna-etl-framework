...
temperature_consumption_table = StaticTableModel(
    identifier=TableIdentifier(
        catalog="silver",
        schema="volue",
        name="temperature_consumption"
    ),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The consumption temperature value in the specified unit"}),
    ...
    comment=(
        "Consumption temperature from Volue. Instance curves and tagged curves store multiple time series. "
