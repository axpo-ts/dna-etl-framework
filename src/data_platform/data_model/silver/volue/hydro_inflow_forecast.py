...
hydro_inflow_forecast_table = StaticTableModel(
    ...
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "The forecasted value of water inflow into hydroelectric reservoirs, in the specified uni"}),
    ...
    comment=(
        "The forecasted values of water inflow into hydroelectric reservoirs. Instance curves store multiple time series. An instance is identified with an issue date."
    ),
    sources=[
