...
power_demand_projection_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteologica", name="power_demand_projection"),
    schema=StructType(
        [
            ...
            StructField("value", StringType(), False, {"comment": "Observed value of power demand projection"}),
    ...
    comment="The table contains projections of power demand across various countries.",
    sources=[TableIdentifier(catalog="bronze", schema="meteologica", name="power_demand_projection")],
