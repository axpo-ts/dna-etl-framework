...
gfs_forecast_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteologica", name="gfs_forecast"),
    schema=StructType(
        [
            ...
            StructField("forecast", StringType(), False, {"comment": "Forecast value from GFS model."}),
    ...
    comment="The table contains forecasts of power generation by different technology (e.g. wind, photovoltaic) across various countries from the Global Forecast System (GFS) model.",
    sources=[TableIdentifier(catalog="bronze", schema="meteologica", name="gfs_forecast")],
