...
power_generation_normal_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteologica", name="power_generation_normal"),
    schema=StructType(
        [
            ...
            StructField("value", StringType(), False, {"comment": "Observed value of power generation normal"}),
    ...
    comment="The table contains total normal power generation by different technology (e.g. wind, photovoltaic) across various countries.",
    sources=[TableIdentifier(catalog="bronze", schema="meteologica", name="power_generation_normal")],
