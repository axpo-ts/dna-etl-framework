...
power_demand_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="meteologica", name="power_demand"),
    schema=StructType(
        [
            ...
            StructField("value", StringType(), False, {"comment": "Observed value of power demand"}),
    ...
    comment="The table contains observations of power demand across various countries.",
    sources=[TableIdentifier(catalog="bronze", schema="meteologica", name="power_demand")],
    primary_keys=("update_id", "issue_date", "content_id", "delivery_start"),
    partition_cols=("update_id",),
    tags={
        **METEOLOGICA_COMMON_TAGS,
        standard_tags.DataSubdomain.KEY: standard_tags.DataSubdomain.DEMAND_AND_SUPPLY,
    },
)
