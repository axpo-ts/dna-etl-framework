...
factor_cannibalization_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="mds", name="factor_cannibalization"),
    schema=StructType([
        ...
        StructField("value", DoubleType(), True, {"comment": "Cannibalization factor for the specified delivery period as of the reference_time"}),
    ...
    comment="Monthly price cannibalization factors of wind and solar power in various geolocations as modelled by Axpo Trading.",
    sources=[
        TableIdentifier(catalog="bronze", schema="mds", name="egl_che_curve_discount_factor"),
