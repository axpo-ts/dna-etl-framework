...
price_afrr_capacity_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="mds", name="price_afrr_capacity"),
    schema=StructType([
        ...
        StructField("up", DoubleType(), True, {"comment": "Pay-as-clear prices for aFRR (automatic frequency regulation reserve) positive capacity reserves"}),
        StructField("down", DoubleType(), True, {"comment": "Pay-as-clear prices for aFRR (automatic frequency regulation reserve) negative capacity reserves"}),
    ...
    comment="Prices for Automatic Frequency Restoration Reserve (aFRR) positive and negative capacity reserves.",
    sources=[
        TableIdentifier(catalog="bronze", schema="mds", name="rte_curves_balancing_reserves"),
