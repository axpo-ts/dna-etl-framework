...
price_weekend_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="mds", name="price_weekend"),
    schema=StructType([
        ...
        StructField("price", DoubleType(), True, {"comment": "Weekend spot prices for the specified product and delivery period, expressed in the specified unit (e.g., EUR/MWh)"}),
    ...
    comment="Weekend spot prices for the specified product and delivery period, expressed in the specified unit (e.g., EUR/MWh)",
    sources=[
