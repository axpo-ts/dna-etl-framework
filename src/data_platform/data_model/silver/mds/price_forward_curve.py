...
price_forward_curve_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="mds", name="price_forward_curve"),
    schema=StructType([
        ...
        StructField("price", DoubleType(), True, {"comment": "Forward prices for the specified product and delivery period, expressed in the specified unit (e.g., EUR/MWh)"}),
    ...
    comment="Forward prices for the specified product and delivery period, expressed in the specified unit (e.g., EUR/MWh)",
    sources=[
        TableIdentifier(catalog="bronze", schema="mds", name="axpo_trading_curve_price_forward_curve"),
        TableIdentifier(catalog="silver", schema="mds", name="attribute"),
        TableIdentifier(catalog="bronze", schema="mds", name="egl_che_curve_price_modelled"),
        TableIdentifier(catalog="bronze", schema="mds", name="heren_curve_price_modelled"),
        TableIdentifier(catalog="bronze", schema="mds", name="albasolu_curve_price_modelled"),
        TableIdentifier(catalog="bronze", schema="mds", name="tfs_uk_curve_price_modelled"),
    ],
    ...
    tags={
        ...
        standard_tags.DataOwner.KEY: standard_tags.DataOwner.LUBOJACKY_VLADISLAV,
