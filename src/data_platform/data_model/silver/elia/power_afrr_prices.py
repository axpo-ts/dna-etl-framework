...
elia_price_afrr_energy_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="elia", name="price_afrr_energy"),
    schema=afrr_schema,
    comment="Prices for Automatic Frequency Restoration Reserve (aFRR) positive and negative activation in Belgium.",
    sources=[TableIdentifier(catalog="bronze", schema="elia", name="afrr_energy_price")],
    tags={
...
elia_price_afrr_capacity_table = StaticTableModel(
    identifier=TableIdentifier(catalog="silver", schema="elia", name="price_afrr_capacity"),
    schema=afrr_schema,
    comment="Prices for Automatic Frequency Restoration Reserve (aFRR) positive and negative capacity reserves in Belgium.",
    sources=[TableIdentifier(catalog="bronze", schema="elia", name="afrr_capacity_price")],
    tags={
        standard_tags.ConfidentialityLevel.KEY: standard_tags.ConfidentialityLevel.C2_INTERNAL,
        standard_tags.DataDomain.KEY: standard_tags.DataDomain.MARKET,
        standard_tags.DataSubdomain.KEY: standard_tags.DataSubdomain.BALANCING_AND_RESERVE,
