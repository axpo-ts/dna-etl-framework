"""Hydro Reservoir curves table model."""
...
hydro_reservoir_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "hydro_reservoir"),
    schema=StructType([
    ...
    comment="Actual and forecast timeseries of hydro reservoir levels pr area from Nena (GWh).",
    sources=[
