"""Precipitation curves table model."""
...
precipitation_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "precipitation"),
    schema=StructType([
    ...
    comment="Actual and forecast timeseries for Precipitation pr area from Nena (GWh).",
    sources=[
