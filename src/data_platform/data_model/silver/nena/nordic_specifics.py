"""Nordic-specific curves table model."""
...
nordic_specifics_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "nordic_specifics"),
    schema=StructType([
    ...
    comment="Hydro generation supplied to the market above and below 5 eur/MWh Nordic. MWh/h.",
    sources=[
