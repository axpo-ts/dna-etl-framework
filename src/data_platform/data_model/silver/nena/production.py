...
production_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "production"),
    schema=StructType([
    ...
    comment="Actual and forecast power production volumes of various technologies (MWh/h).",
    sources=[
