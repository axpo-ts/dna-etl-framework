"""Price Forecast curves table model."""
...
price_forecast_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "price_forecast"),
    schema=StructType([
    ...
    comment="Actual and forecast prices pr area from Nena (Eur/MWh).",
    sources=[
