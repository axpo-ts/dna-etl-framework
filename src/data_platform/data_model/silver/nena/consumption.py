"""Consumption curves table model."""
...
consumption_table = StaticTableModel(
    identifier=TableIdentifier("silver", "nena", "consumption"),
    schema=StructType([
    ...
    comment="Actual and forecast timeseries for Consumption pr area from Nena (MWh/h).",
    sources=[
    ...
    tags={
        **nena_common.NENA_COMMON_TAGS,
        ...
        standard_tags.DataSubdomain.KEY: standard_tags.DataSubdomain.CONSUMPTION,
    },
